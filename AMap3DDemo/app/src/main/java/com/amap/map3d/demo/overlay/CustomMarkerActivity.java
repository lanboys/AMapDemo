...
public class CustomMarkerActivity extends Activity implements OnMarkerClickListener,
    ...
    private void addMarkersToMap() {
        ...
        marker1.setPositionByPixels(400, 400);
        ...
        //添加 西安 成都
        List<Marker> markerList = aMap.addMarkers(markerOptionList, true);
    ...
    public boolean onMarkerClick(final Marker marker) {
        if (aMap != null) {
            if (marker.equals(marker2)) {//西安
                jumpPoint(marker);
            } else if (marker.equals(marker3)) {//郑州
                growInto(marker);
            }
        }
